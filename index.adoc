...
* You can find sample answers to these questions at the very end of the eBook, in the https://timmcmichael.github.io/skimpy-oop/_stuff_thats_tacked_on_the_end.html[*Stuff That's Tacked on the End*] section.
