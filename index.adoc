...
* Java is _strongly, staticly typed_, meaning we have to declare data types when we make our variables and that type can't change. I believe this "stricter" approach to data types is better for beginners. 
