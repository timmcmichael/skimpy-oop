...
#Unfortunately, as of Spring 2025 this book is *too* skimpy and is still being written, so you'll need the textbook listed in Canvas as well--sorry, I just can type fast enough.# 
