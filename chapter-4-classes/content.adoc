...
video::rwiAV-R5EEI[youtube, list=PL_Lc2HVYD16Y-vLXkIgggjYrSdF5DEFnU]
// https://youtu.be/rwiAV-R5EEI
****


==== Using the Class
#This subsection doesn't have a video yet. What it does have is typos. In the meantime, consider reading section 4.4 in the book instead.#
