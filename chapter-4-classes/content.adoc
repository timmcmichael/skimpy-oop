...
#This section is still pretty rough, but in the meantime this content is covered in section 4.2 (page 117) through 4.5 in the textbook.#
...
#This subsection is coming next!#
...
.Interesting
====
I asked an AI platform to give me an image of an angry mob with pitchforks and torches, and the AI spit out link:images/creepy_mob.png[nightmare fuel].
I decided it was too creepy to display in the text. If a mob like that comes for me, I'll let them put `print()` statements wherever they want!
====
...
Here's an example of a driver class that uses the `WeatherRecord` class:

.`WeatherRecordDriver.java`. A driver class that uses the `WeatherRecord` class.
[source,java]
----
public class WeatherRecordDriver {
    public static void main(String[] args) {
        WeatherRecord record = new WeatherRecord();
        record.setDate("2023-10-01");
        record.setHighTemperature(75);
        record.setAverageWindSpeed(10.5);

        System.out.println("Date: " + record.getDate());
        System.out.println("High Temperature: " + record.getHighTemperature());
        System.out.println("Average Wind Speed: " + record.getAverageWindSpeed());
    }
}
----
