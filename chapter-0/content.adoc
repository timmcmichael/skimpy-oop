...
I've put together detailed installion instructions--but if they are outdated there are about a gazillion web pages and Youtube videos that will show you the process.
